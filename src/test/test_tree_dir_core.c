...
static void test_create_noeud(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test", pere);
    ...
    handle_boolean_test(true, are_noeuds_equal(pere, node1->pere), __LINE__, __FILE__, info);
    handle_boolean_test(true, are_noeuds_equal(pere->racine, node1->racine), __LINE__, __FILE__, info);
    handle_boolean_test(true, node1->fils == NULL, __LINE__, __FILE__, info);

    liste_noeud *node_list = create_liste_noeud(node1);
    ...
    if (node2->fils != NULL)
    {
        handle_boolean_test(true, are_noeuds_equal(node2->fils->no, node1), __LINE__, __FILE__, info);
    }
...
static void test_are_noeud_equal(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test", root_node1);
    append_a_fils_to_noeud(root_node1, node1);
    handle_boolean_test(true, are_noeuds_equal(node1, node1), __LINE__, __FILE__, info);
    ...
    handle_boolean_test(false, are_noeuds_equal(node1, node2), __LINE__, __FILE__, info);
...
static void test_is_root_node(test_info *info)
{
    ...
    noeud *node1 = create_noeud(true, "test", root_node);
    append_a_fils_to_noeud(root_node, node1);
...
static void test_is_fils_of_node_empty(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test", root);
...
static void test_create_liste_noeud(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test1", root_node);

    root_node->fils = create_liste_noeud(node1);
...
static void test_contains(test_info *info)
{
    ...
    noeud *node1 = create_noeud(true, "test", root_node);
    handle_boolean_test(false, contains_liste_noeud(root_node->fils, node1), __LINE__, __FILE__, info);
    append_a_fils_to_noeud(root_node, node1);
    handle_boolean_test(true, contains_liste_noeud(root_node->fils, node1), __LINE__, __FILE__, info);
    ...
    node1 = create_noeud(false, "test4", root_node);
    handle_boolean_test(false, contains_liste_noeud(root_node->fils, node1), __LINE__, __FILE__, info);
...
static void test_get(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test", root_node);
    append_a_fils_to_noeud(root_node, node1);
    handle_boolean_test(true, are_noeuds_equal(get_a_fils_of_noeud(root_node, "test"), node1), __LINE__, __FILE__,
                        info);
    ...
    node1 = create_noeud(false, "test3", root_node);
    ...
    handle_boolean_test(true, are_noeuds_equal(get_a_fils_of_noeud(root_node, "test3"), node1), __LINE__, __FILE__,
                        info);
...
static void test_append(test_info *info)
{
    ...
    noeud *node1 = create_noeud(false, "test", root_node);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node1) == SUCCESS, __LINE__, __FILE__, info);
    handle_boolean_test(true, root_node->fils != NULL, __LINE__, __FILE__, info);
    handle_boolean_test(true, are_noeuds_equal(root_node->fils->no, node1), __LINE__, __FILE__, info);
    ...
    noeud *node2 = create_noeud(false, "test2", root_node);
    handle_boolean_test(false, contains_liste_noeud(root_node->fils, node2), __LINE__, __FILE__, info);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node2) == SUCCESS, __LINE__, __FILE__, info);
    handle_boolean_test(true, contains_liste_noeud(root_node->fils, node2), __LINE__, __FILE__, info);
    handle_boolean_test(true, are_noeuds_equal(node2->pere, root_node), __LINE__, __FILE__, info);
    handle_boolean_test(true, are_noeuds_equal(node2->racine, root_node), __LINE__, __FILE__, info);

    handle_boolean_test(true, append_a_fils_to_noeud(node1, node2) == INVALID_SELECTION, __LINE__, __FILE__, info);
    handle_boolean_test(true, append_a_fils_to_noeud(node2, node1) == INVALID_SELECTION, __LINE__, __FILE__, info);

    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node2) == INVALID_NAME, __LINE__, __FILE__, info);

    handle_boolean_test(true, append_a_fils_to_noeud(root_node, create_noeud(false, "test3", root_node)) == SUCCESS,
                        __LINE__, __FILE__, info);
    handle_boolean_test(true, contains_liste_noeud(root_node->fils, node2), __LINE__, __FILE__, info);

    handle_boolean_test(true, size_liste_noeud(root_node->fils) == 3, __LINE__, __FILE__, info);

    node1 = create_noeud(true, "test", root_node);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node1) == INVALID_NAME, __LINE__, __FILE__, info);
    free(node1);

    node1 = create_noeud(false, "test", root_node);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node1) == INVALID_NAME, __LINE__, __FILE__, info);
    free(node1);

    node1 = create_noeud(true, "test2", root_node);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node1) == INVALID_NAME, __LINE__, __FILE__, info);
    free(node1);

    node1 = create_noeud(true, "test3", root_node);
    handle_boolean_test(true, append_a_fils_to_noeud(root_node, node1) == INVALID_NAME, __LINE__, __FILE__, info);
    free(node1);
    destroy_noeud(root_node);
}
...
static void test_remove(test_info *info)
{
    ...
    handle_boolean_test(true, contains_noeud(root_node, node1), __LINE__, __FILE__, info);
    handle_boolean_test(true, remove_a_node_from_fils(root_node, node1) == SUCCESS, __LINE__, __FILE__, info);
    handle_boolean_test(false, contains_noeud(root_node, node1), __LINE__, __FILE__, info);
    ...
    handle_boolean_test(true, remove_a_fils_of_noeud(root_node, node1->nom) == SUCCESS, __LINE__, __FILE__, info);
    handle_boolean_test(true, root_node->fils == NULL, __LINE__, __FILE__, info);
    handle_boolean_test(true, remove_a_fils_of_noeud(root_node, node1->nom) == INVALID_SELECTION, __LINE__, __FILE__,
                        info);

    destroy_noeud(root_node);

    node1 = create_root_noeud();
    liste_noeud *list = create_liste_noeud(node1);
    handle_boolean_test(true, remove_liste_noeud(list, node1) == NULL, __LINE__, __FILE__, info);
...
static void test_search_without_create(test_info *info)
{
    ...
    noeud *node1 = search_node_in_tree(current_node, "test/test2");
...
static void test_search_with_create(test_info *info)
{
    ...
    noeud *node1 = search_node_in_tree_with_node_creation(current_node, "test/test2", false);
    absolute_path = get_absolute_path_of_node(node1);
    handle_string_test("/test/test2", absolute_path, __LINE__, __FILE__, info);
    handle_boolean_test(false, are_noeuds_equal(node1, search_node_in_tree(current_node, "test/test2")), __LINE__,
                        __FILE__, info);
    free(absolute_path);
    ...
    handle_boolean_test(false, are_noeuds_equal(node1, search_node_in_tree(current_node, "test12/test42")), __LINE__,
                        __FILE__, info);
    ...
    handle_boolean_test(false, are_noeuds_equal(node1, search_node_in_tree(current_node, "test")), __LINE__, __FILE__,
                        info);
