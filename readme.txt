...
"-o=output.txt" qui permet en remplaçant "output.txt" par un fichier de sortie, d'afficher les résultats des commandes dans ce fichier au lieu du terminal courant (si le fichier n'existe pas, il est alors créer si c'est possible)
...
Dans les inputs donnés, les chemins doivent respecter la forme donnés dans les consignes de projet.
